...
class MemebershipStatement extends StatefulWidget {
  @override
  _MemebershipStatementState createState() => _MemebershipStatementState();
}

class _MemebershipStatementState extends State<MemebershipStatement> {
  ...
  Widget build(BuildContext context) {    
    return Scaffold(
      appBar: AppBar(
          title: Text('Memebership Statement'),
